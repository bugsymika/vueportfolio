<template>
  <div class="main">
    ...
    <div class="textContainer">
      <p>My name is Bug and I’m a 100% self taught front-end web developer. I prefer working with the Vue framework however my understanding of vanilla JavaScript allows me to pick up libraries and frameworks and quickly get up to speed with them.
        <br>
